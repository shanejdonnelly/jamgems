    ...
    <div class="container">
      ...
      <div class="row portfolio">
        ...
        <div class="span2">
          ...
          <p class="button_wrap"><a class="btn " target="_blank" href="https://github.com/shanejdonnelly/portfolio/blob/master/timberland_lookbook/script.js">JS &raquo;</a></p>
          <p class="button_wrap"><a class="btn " target="_blank" href="https://github.com/shanejdonnelly/portfolio/blob/master/timberland_lookbook/plugins.js">JS &raquo;</a></p>
          <p class="button_wrap"><a class="btn " target="_blank" href="https://github.com/shanejdonnelly/portfolio/blob/master/timberland_lookbook/style.css">CSS &raquo;</a></p>
        </div>
        <div class="span5">
          ...
          <p>
            One of my favorite bits of this site was coding the custom animations that are scattered throughout. The site was designed to be 
            interactive and has lots of panning and movement. The navigation bar, while subtle, required a lot of thought to get the detail right. 
            A few noteworthy features: <br/>
            <ul>
              <li>The size of the nav bar is automatically scaled to the size of the overall page</li>
              <li>The indicator is proportionally scaled to represent the user's viewport size</li>
            </ul>
          </p>
          <p>
      ...
      <div class="row portfolio">
        ...
        <div class="span2">
          ...
          <p class="button_wrap"><a class="btn " target="_blank" href="https://github.com/shanejdonnelly/portfolio/blob/master/timberland_bootco/style.css">CSS &raquo;</a></p>
      ...
      <div class="row portfolio">
        ...
        <div class="span5">
          ...
          <p>
            ...
            design of the site, but I enjoyed fully utilizing CSS3 to create some neat shapes and effects. I also created a few custom 
