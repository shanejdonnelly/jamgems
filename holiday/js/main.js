...
$(document).ready(function(){
    ...
    function showJam(){
        ...
        setTimeout(function(){$('#j1').fadeIn(500);}, 5500); 
        setTimeout(function(){$('#j2').fadeIn(500);}, 1500); 
        setTimeout(function(){$('#j3').fadeIn(500);}, 3500); 
        setTimeout(function(){$('#j4').fadeIn(500);}, 2500); 
        
        //row 2
        setTimeout(function(){$('#j5').fadeIn(500);}, 4000); 
        setTimeout(function(){$('#j6').fadeIn(500);}, 3000); 
        setTimeout(function(){$('#j7').fadeIn(500);}, 5000); 
        setTimeout(function(){$('#j8').fadeIn(500);}, 4500); 
